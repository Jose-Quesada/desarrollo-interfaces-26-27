...
**RA 2. Genera interfaces web utilizando herramientas de diseño visual.**

Esta unidad representa la culminación del módulo y trabaja de manera intensiva este resultado de aprendizaje en todos sus criterios de evaluación:

- CE a. Se han reconocido los elementos de una interfaz web (botones, formularios, tablas, menús, tarjetas, modales) — analizando diseños y descomponiéndolos en componentes.
- CE b. Se han utilizado herramientas de diseño visual para generar interfaces — Figma como fuente de diseño, Dev Mode para inspección, variables como fuente de tokens.
- CE c. Se ha generado un sistema de diseño con elementos reutilizables — componentes Angular standalone + Tailwind + Storybook como sistema de diseño implementado.
- CE d. Se han aplicado los principios de diseño responsive — layouts con Tailwind/Grip/Flexbox adaptados a diseño responsive definido en Figma.
- CE e. Se han utilizado herramientas de desarrollo para generar interfaces — Angular CLI, Tailwind, Storybook, VS Code, ESLint, Prettier.

**RA 3. Implementa interfaces web utilizando lenguajes de marcas y hojas de estilo.**

Criterios de evaluación trabajados:
- CE a. Se han utilizado lenguajes de marcas para estructurar el contenido — HTML5 semántico en templates Angular.
- CE b. Se han aplicado hojas de estilo en cascada para el diseño visual — Tailwind CSS a partir de design tokens.
- CE c. Se han integrado elementos multimedia en las interfaces — exportación e integración de assets desde Figma.
- CE d. Se han aplicado técnicas de accesibilidad web según estándares WCAG.
...
- **Unidad 2:** Entorno de desarrollo completo configurado (Node.js, Angular CLI, Tailwind CSS 4, ESLint, Prettier, Storybook, Git). TypeScript (tipos, interfaces, genéricos, decoradores). Angular (standalone components, signals, control flow @if/@for, inputs/outputs, servicios, routing). Tailwind (clases utilitarias, configuración @theme, responsive prefixes, dark mode).
- **Unidad 3:** Figma a nivel de diseño (Auto Layout, componentes, variantes, variables, Dev Mode, exportación de assets, handoff).
- **Unidad 4:** Layouts modernos con Flexbox, CSS Grid y posicionamiento a través de Tailwind. Construcción de dashboards, layouts SaaS, ecommerce y aplicaciones de chat.

Antes de iniciar esta unidad, se verificará que todo el alumnado tiene su entorno funcional y su proyecto Angular + Tailwind + Storybook operativo (el creado en la Unidad 2). Quienes no lo tengan recibirán un proyecto base para no quedar rezagados.
