...
- Se han aplicado principios de accesibilidad en el diseño de componentes de interfaz.
- Se ha documentado la interfaz de uso de los componentes desarrollados.
- Se han utilizado herramientas de diseño visual para definir la apariencia de los componentes.
...
- Storybook: desarrollo y documentación aislada de componentes (Unidad 10).
