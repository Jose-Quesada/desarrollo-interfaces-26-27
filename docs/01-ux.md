...
![Relación entre el sistema y el mundo real](./img/01/relación-sistema-mundo-real.webp)
...
![Consistencia y estándares](./img/01/consistencia-estandares.png)
...
![Prevención de errores](./img/01/prevención-errores.png)
...
![Reconocimiento antes que recuerdo](./img/01/reconocimiento.png)
...
![Flexibilidad y eficiencia](./img/01/flexibilidad-eficiencia.webp)
...
![Diseño estético y minimalista](./img/01/estético-minimalista.png)
...
![Ayudar a reconocer, diagnosticar y recuperarse de errores](./img/01/reconocer-diagnosticar.webp)

*Los mensajes de error tienen que indicar claramente los errores,  sus causas y cómo subsanarlos. Mensajes específicos como “Insertar una contraseña de por lo menos 8 caracteres” son siempre preferibles que mensajes genéricos como “contraseña no válida”*
...
![Ayuda y documentación](./img/01/ayuda-documentacion.webp)
