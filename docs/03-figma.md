...
Este resultado de aprendizaje se concreta en los siguientes criterios de evaluación del currículo oficial:

- CE b. Se han descrito las características y tecnologías de los diferentes tipos de interfaces, aplicándolo al diseño de interfaces gráficas de usuario.
- CE d. Se han identificado las herramientas de desarrollo de interfaces de usuario, con especial atención a Figma como herramienta de diseño visual.
- CE g. Se ha analizado la configuración de un entorno de desarrollo de interfaces, extendiéndolo al entorno de diseño (Figma, plugins, Dev Mode).

Asimismo, esta unidad contribuye al RA 2 del módulo ("Genera interfaces web utilizando herramientas de diseño visual") en sus criterios de evaluación:

- CE a. Se han reconocido los elementos de una interfaz web (botones, formularios, tablas, menús, tarjetas, modales).
- CE b. Se han utilizado herramientas de diseño visual para generar interfaces (Figma).
- CE c. Se ha generado un sistema de diseño con elementos reutilizables.
...
- Conocimientos básicos de Tailwind CSS vistos en la Unidad 2, especialmente la nomenclatura de colores, tamaños de espaciado y sistema responsive. Figma y Tailwind comparten filosofía de sistema de diseño, y estableceremos equivalencias directas entre ambos.
- Experiencia con el entorno de desarrollo configurado en la Unidad 2 (Angular + Tailwind + Storybook + VS Code) porque, aunque esta unidad se centre en Figma, los diseños que creemos serán implementados posteriormente en Angular + Tailwind. La unidad 5 cerrará el ciclo.
...
- Analogía con el desarrollo: el sistema de diseño en Figma es el equivalente al sistema de diseño en código (componentes Angular + estilos Tailwind). El objetivo de las Unidades 3 y 5 es alinear ambos.
...
Y las variantes visuales de Figma (colores, bordes, tamaños) se traducirán a clases condicionales de Tailwind en el template, de forma similar a como hicimos con el componente Button en la Unidad 2.
...
**Resultado:** Una pantalla de login profesional, completa, con modo claro y oscuro, utilizando componentes reutilizables (Button, Input — si lo creamos como componente), variables semánticas y Auto Layout en toda su jerarquía. Preparada para ser implementada en Angular + Tailwind en la Unidad 4 (layout) y Unidad 5 (handoff a código).
...
En la Unidad 4, nos centraremos en los layouts modernos con Flexbox y CSS Grid implementados con Tailwind CSS, construyendo las estructuras sobre las que se asentarán los componentes diseñados en esta unidad. En la Unidad 5, recorreremos el camino completo: desde un diseño en Figma hasta una aplicación Angular completa, pasando por la extracción de tokens, la configuración de Tailwind y la implementación de componentes documentados en Storybook.
