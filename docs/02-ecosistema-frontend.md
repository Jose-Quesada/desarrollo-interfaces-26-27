...
Este RA, presente en el currículo oficial del ciclo de DAM en Andalucía, se concreta en los siguientes criterios de evaluación trabajados en esta unidad:

- CE d. Se han identificado las herramientas de desarrollo de interfaces de usuario (Angular CLI, Visual Studio Code, Figma, Storybook).
- CE e. Se han valorado las tendencias actuales en el diseño de interfaces (Tailwind CSS utility-first, componentes standalone, signals).
- CE g. Se ha analizado la configuración de un entorno de desarrollo de interfaces (Node.js, npm, ESLint, Prettier, Git).
...
- Próximamente: Unidad 3 dedicada íntegramente a Figma.
...
Dedicaremos la Unidad 3 íntegramente a Figma, donde aprenderemos a diseñar componentes, crear sistemas de diseño con variables y preparar diseños para la implementación. Por ahora, es suficiente entender su rol en el ecosistema y comenzar a familiarizarse con su interfaz.
...
En la Unidad 3 nos sumergiremos en Figma para dominar el diseño de interfaces: crearemos componentes, sistemas de diseño con variables, prototipos interactivos y especificaciones para desarrollo. En la Unidad 4 abordaremos los layouts modernos con Flexbox, CSS Grid y Tailwind. En la Unidad 5 conectaremos todos los extremos recorriendo el camino completo desde un diseño en Figma hasta una aplicación Angular funcional con componentes documentados en Storybook.
