...
Este proyecto final integrador evalúa de forma conjunta todos los resultados de aprendizaje del módulo profesional 0488 Desarrollo de Interfaces, conforme al currículo oficial del Ciclo Formativo de Grado Superior en Desarrollo de Aplicaciones Multiplataforma (DAM) en Andalucía:

- **RA 1. Diseña interfaces de usuario** (Figma, Design System, diseño responsive)
- **RA 2. Implementa interfaces de usuario** (Angular standalone, Tailwind CSS, componentes, formularios, routing)
- **RA 3. Crea aplicaciones multiplataforma** (Electron, integración Angular + Electron, funcionalidades nativas)
- **RA 4. Distribuye aplicaciones multiplataforma** (electron-builder, instaladores, CI/CD opcional)
- **RA 5. Desarrolla interfaces interactivas y dashboards** (Chart.js, KPI cards, gráficos interactivos, filtros)
- **RA 6. Genera informes y documentación** (PDFMake, facturas PDF, informes, exportación CSV/Excel)
...
Este proyecto integrador presupone que el alumnado ha cursado y superado las 19 unidades didácticas anteriores del módulo 0488 Desarrollo de Interfaces, así como los módulos de primero y segundo curso que proporcionan la base de programación, bases de datos, entornos de desarrollo y sistemas informáticos.
...
1. Configurar el proceso principal (`main.js`), preload (`preload.js`) y `ElectronService` en Angular (siguiendo los patrones de la unidad 18).
...
3. Configurar electron-builder (siguiendo la unidad 19) para generar instaladores para las 3 plataformas.
