...
Esta unidad contribuye al Resultado de Aprendizaje 5 del currículo del módulo 0488 Desarrollo de Interfaces del CFGS Desarrollo de Aplicaciones Multiplataforma (DAM) en Andalucía: "Desarrolla interfaces de usuario utilizando frameworks de estilos y preprocesadores CSS, aplicando las técnicas y los estándares de maquetación web actuales para entornos de aplicación de escritorio y web."

Criterios de evaluación asociados:
- Se han identificado las características y ventajas de los frameworks CSS utility-first en el desarrollo de interfaces de aplicación.
- Se ha configurado un framework de estilos en un proyecto Angular, personalizando las variables de diseño mediante la directiva `@theme`.
- Se ha organizado el código CSS del proyecto siguiendo buenas prácticas de mantenibilidad y reutilización.
- Se han aplicado las clases utility del framework para construir interfaces completas, incluyendo layout, tipografía, colores, estados interactivos y diseño responsive.
- Se han utilizado técnicas avanzadas como valores arbitrarios, variantes `peer` y `group`, y el selector `has-*` para resolver necesidades de diseño complejas sin CSS personalizado.
- Se ha evaluado la idoneidad del enfoque utility-first frente al CSS tradicional en diferentes escenarios de desarrollo.
...
- Conocimientos previos de diseño responsive y principios de UX (Unidades 11 y 12), ya que Tailwind incluye utilidades específicas para accesibilidad y diseño responsive que se apoyan en esos fundamentos.
